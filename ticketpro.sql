...
VALUES ('Administrador', 'admin@ticketpro.com',
        '$2a$10$YgQyc1/XGf9VuPCJ60.vv.w0CjOOzcYsdrq5jtj6J.Vf47Fzz5A2G',
        'ADMIN');

INSERT INTO usuarios (nombre, email, password, rol)
VALUES ('Tecnico Soporte', 'tecnico@ticketpro.com',
        '$2a$10$G5Td4a.oY7Xp1KWhP019XeVeNkSjj5CS3aHwJgF/0KpUsIwITtnEi',
        'INFORMATICO');
